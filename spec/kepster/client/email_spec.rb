...
RSpec.describe Kepster::Client::Email do
  describe "#register" do
    ...
    context "registration is not allowed" do
      ...
      it 'raise an error' do
        VCR.use_cassette('email/register/registration_not_allowed') do
    ...
    context "when registration is allowed" do
      ...
      it 'successfully registers the user' do
        VCR.use_cassette('email/register/registration_allowed') do
          response = subject
